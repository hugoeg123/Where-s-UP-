...
// A generic prop type for SVG components
...
export const UserGroupIcon: React.FC<SVGProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.513-.96 1.887-1.634 3.283-1.634 1.4 0 2.77.674 3.283 1.634M10.5 18.72c-1.4 0-2.77-.674-3.283-1.634M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);
...
export const FlagIcon: React.FC<SVGProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 3v1.5M3 21v-6m0 0l2.77-.693a9 9 0 016.208.682l.108.054a9 9 0 006.086.71l3.114-.732a48.524 48.524 0 01-.005-10.499l-3.11.732a9 9 0 01-6.085-.711l-.108-.054a9 9 0 00-6.208-.682L3 4.5M3 4.5v.75m0 0l2.77.693a9 9 0 016.208-.682l.108-.054a9 9 0 006.086-.71l3.114.732a48.524 48.524 0 00.005 10.499l-3.11-.732a9 9 0 01-6.085.711l-.108.054a9 9 0 00-6.208.682L3 15m0 0v-1.5" />
    </svg>
);

export const ShareIcon: React.FC<SVGProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.195.025.39.05.588.08a2.25 2.25 0 011.834 1.834.06.06 0 00.11.028l.053-.053a2.25 2.25 0 013.182 0l.053.053a.06.06 0 00.11.028 2.25 2.25 0 011.834-1.834c.198-.03.393-.055.588-.08a2.25 2.25 0 000-2.186c-.195-.025-.39-.05-.588-.08a2.25 2.25 0 01-1.834-1.834.06.06 0 00-.11-.028l-.053-.053a2.25 2.25 0 01-3.182 0l-.053.053a.06.06 0 00-.11-.028 2.25 2.25 0 01-1.834 1.834c-.198.03-.393.055-.588.08z" />
    </svg>
);

export const QrCodeIcon: React.FC<SVGProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5a3 3 0 00-3 3v10.5a3 3 0 003 3h10.5a3 3 0 003-3V7.5a3 3 0 00-3-3H3.75zM3.75 9h7.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V9h-4.5V4.5H15zM15 9h4.5v3.375c0 .621-.504 1.125-1.125 1.125H15V9z" />
    </svg>
);
...
export const UsersIcon: React.FC<SVGProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M4.5 6.375a4.125 4.125 0 118.25 0 4.125 4.125 0 01-8.25 0zM14.25 8.625a4.125 4.125 0 118.25 0 4.125 4.125 0 01-8.25 0zM1.5 15.75a3 3 0 013-3h3a3 3 0 013 3v.75a.75.75 0 01-1.5 0v-.75a1.5 1.5 0 00-1.5-1.5h-3a1.5 1.5 0 00-1.5 1.5v.75a.75.75 0 01-1.5 0v-.75zM12.75 15.75a3 3 0 013-3h3a3 3 0 013 3v.75a.75.75 0 01-1.5 0v-.75a1.5 1.5 0 00-1.5-1.5h-3a1.5 1.5 0 00-1.5 1.5v.75a.75.75 0 01-1.5 0v-.75z" />
    </svg>
);
...
export const GoogleIcon: React.FC<SVGProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="20px" height="20px">
    ...
    <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571l6.19,5.238C39.99,34.556,44,28.718,44,24C44,22.659,43.862,21.35,43.611,20.083z"/>
  </svg>
);
